class Game{
    ...
    async start(){
      ...
      fighter1.addImage("fighter1",fighter2_img);
      fighter2 = createSprite(300,200);
      fighter2.addImage("fighter2",fighter5_img);
      fighter3 = createSprite(500,200);
      fighter3.addImage("fighter3",fighter14_img);
      fighter4 = createSprite(700,200);
      fighter4.addImage("fighter4",fighter16_img);
